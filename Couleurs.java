public class Couleurs {
    ...
    public static String[] tableau1 = new String[] { "\u001B[30m", "\u001B[31m",
            "\u001B[32m", "\u001B[33m", "\u001B[34m",
            "\u001B[35m", "\u001B[36m" };

            // tableau1[0]=(String)"gris";
            // tableau1[1]=(String)"rouge";
            // tableau1[2]=(String)"vert";
            // tableau1[3]=(String)"jaune";
            // tableau1[4]=(String)"bleu";
            // tableau1[5]=(String)"violet";
            // tableau1[6]=(String)"cyan";}

    public static String FIN = "\u001B[0m";
