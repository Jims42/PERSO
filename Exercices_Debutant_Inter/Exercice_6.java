...
// Consigne: Écris un programme avec une méthode calculerFactorielle qui prend un entier en paramètre et retourne sa factorielle. 
// Demande à l'utilisateur un nombre et affiche sa factorielle.
   ...
   public static void main(String[] args) {
      ...
      if (clavier.hasNextInt()) {
         ...
         if (nombre <= 0) {
            ...
            System.out.println("La factorielle de [\u001B[33m" + nombre + "\u001B[0m] est : \u001B[4;32m" + resultat
                  + "\u001B[4;0m");
